...
<body>
	...
	<div>
		<ul>
			...
			<li><a href="restful.jsp" target="_blank">restful test</a></li>
			...
			<li><a href="classNameHandlerMapping/classNameHandlerMappingTest" target="_blank">classNameHandlerMapping test</a></li>
